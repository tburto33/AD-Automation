...
//        String itemName = "oldtitle";
//
//        HashMap<Integer, String> arcWarden = dotaData.getArcWarden();
//        arcWarden.put(1, collectAttributeFromElementByAttributeName(arcWardenPageHeaderHeroImage, itemName));
//        arcWarden.put(2, secondItemName);
//        arcWarden.put(3, thirdItemName);
//        System.out.println("Arc Warden's Top Items This Week: " + "\n" + arcWarden);
//    }
//
//    public String collectAttributeFromElementByAttributeName(WebElement element, String attributeName) {
